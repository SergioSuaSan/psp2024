package psp_2024.redes.EJEMPLOS_LIBRO_TEXTO.clasesURL;
...
public class Ejemplo3urlCon {
  ...
  public static void main(String[] args) throws Exception {
   String cadena;
   URL url = new URL("http://localhost/ver_nombre/vernombre.html");
...
conexion.getHeaderField(1));
   ...
   //System.out.println("getContentType(): " + conexion.getContentType());
